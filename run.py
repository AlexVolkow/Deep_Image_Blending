...
parser.add_argument('--ss', type=int, default=640, help='source image size')
parser.add_argument('--ts', type=int, default=640, help='target image size')
parser.add_argument('--x', type=int, default=320, help='vertical location')
parser.add_argument('--y', type=int, default=320, help='vertical location')
